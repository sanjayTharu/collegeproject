...
movies=pd.read_csv(r'C:\Users\Tharu\OneDrive\Desktop\project\\movies.csv')
movies.head()
...
ratings=pd.read_csv(r'C:\Users\Tharu\OneDrive\Desktop\project\\ratings.csv',usecols=['userId','movieId','rating'])
ratings.head()
