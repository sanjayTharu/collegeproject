...
movies_path = os.path.join(DATA_DIR, 'data/movies.csv')
ratings_path = os.path.join(DATA_DIR, 'data/ratings.csv')
...
SECRET_KEY = 'django-insecure-0r+6^76r447nd&+izytlb^hmo447m$*d6a@g_$2y%z)k)b5q%j'
